...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        languaches.add(ProgrammingLanguage("Java", "Джеймс\nГослинг", 1995, "????", java, 1, "https://ru.wikipedia.org/wiki/Java"))
        languaches.add(ProgrammingLanguage("C", "Деннис Ритчи,\nКен Томпсон", 1972, "????", c, 2, "https://en.wikipedia.org/wiki/C_(programming_language)"))
        languaches.add(ProgrammingLanguage("Python", "Гвидо\nВан Россум", 1990, "????", python, 3, "https://ru.wikipedia.org/wiki/Python"))
        languaches.add(ProgrammingLanguage("С++", "Бьёрн\nСтрауструп", 1983, "????", cplusplus, 4, "https://ru.wikipedia.org/wiki/C%2B%2B"))
        languaches.add(ProgrammingLanguage("Visual Basic", "Microsoft", 1991, "????", visualbasic, 5, "https://ru.wikipedia.org/wiki/Visual_Basic"))
        languaches.add(ProgrammingLanguage("Java Script", "Брендан Эйх", 1995, "????", javascript, 6, "https://ru.wikipedia.org/wiki/JavaScript"))
        languaches.add(ProgrammingLanguage("C#", "Андерс\nХейлсберг", 2000, "????", csharp, 7, "https://ru.wikipedia.org/wiki/C_Sharp"))
        languaches.add(ProgrammingLanguage("PHP", "Расмус\nЛердорф", 1995, "????", php, 8, "https://ru.wikipedia.org/wiki/PHP"))
        languaches.add(ProgrammingLanguage("SQL", "Д. Чемберлин,\nР. Бойс", 1974, "????", sql, 9, "https://ru.wikipedia.org/wiki/SQL"))
        languaches.add(ProgrammingLanguage("Objective C", "Бред\nКокс", 1983, "????", objectivec, 10, "https://ru.wikipedia.org/wiki/Objective-C"))
